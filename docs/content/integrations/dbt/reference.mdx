...
Row counts are fetched in parallel to the execution of your dbt models. To enable this feature, call PyObject module="dagster_dbt" object="DbtEventIterator" method="fetch_row_counts" /> on the \<PyObject module="dagster_dbt" object="DbtEventIterator/> returned by the `stream()` dbt CLI call:
